...
const BANK = [
  ...
  { m:'AR', q:"一个矩形长 12 宽 8，面积？", c:["80","88","92","96"], a:3, e:"12×8=96。" },
  ...
  // WK / PC 词汇与阅读
  { m:'WK', q:"单词 'benevolent' 的意思是？", c:["恶意的","友善的","懒惰的","冷漠的"], a:1, e:"bene- 表示 '好'，benevolent=善良的。" },
  { m:'WK', q:"'antonym' 意思是？", c:["同义词","反义词","名词","形容词"], a:1, e:"antonym = opposite meaning word。" },
  { m:'WK', q:"阅读理解：'The sun dipped below the horizon' 的含义是？", c:["太阳升起","太阳下山","天气炎热","夜晚来临"], a:1, e:"dipped below horizon = 太阳下山。" },
  { m:'WK', q:"词根 'bio' 的含义？", c:["生命","时间","地球","声音"], a:0, e:"bio = life。" },
  { m:'WK', q:"句子 'He was reluctant to speak' 中的 'reluctant' 意思是？", c:["渴望的","害怕的","不情愿的","兴奋的"], a:2, e:"reluctant = unwilling。" },

  // GS 自然科学
  { m:'GS', q:"水的化学式是？", c:["H₂O","CO₂","O₂","NaCl"], a:0, e:"H₂O = 水。" },
  { m:'GS', q:"地球围绕太阳旋转的时间约为？", c:["1 天","1 周","1 月","1 年"], a:3, e:"地球公转一圈约为 1 年。" },
  { m:'GS', q:"呼吸系统的主要器官是？", c:["心脏","肺","肾","胃"], a:1, e:"肺负责气体交换。" },
  { m:'GS', q:"植物通过什么制造食物？", c:["消化作用","光合作用","蒸发作用","氧化作用"], a:1, e:"光合作用。" },
  { m:'GS', q:"能量单位是？", c:["米","焦耳","升","克"], a:1, e:"焦耳 (J) 表示能量。" }
];
...
document.getElementById('exportWrong').addEventListener('click',()=>{
  const data=wrongList.map(w=>({
    module:w.m,question:w.q,choices:w.c,correctIndex:w.a,userIndex:w.user,explanation:w.e
  }));
  const blob=new Blob([JSON.stringify({exportedAt:new Date().toISOString(),items:data},null,2)],{type:'application/json'});
  const url=URL.createObjectURL(blob);
  const a=document.createElement('a');
  a.href=url;a.download='asvab_wrong_questions.json';a.click();
